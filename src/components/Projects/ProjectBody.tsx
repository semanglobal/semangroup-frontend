            ...
            <div className='max-w-[1440px] mx-auto space-y-20'>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    {projects.map((project) => (
                        <div
                            key={project.id}
                            className="group relative w-full h-[550px] overflow-hidden border hover:shadow-lg transition"
                        >
                            {/* Background Image */}
                            <div
                            ...
                            <div className="absolute bottom-16 left-10 z-10">
                                ...
                                <button className="py-2 px-6 bg-primary hover:bg-primary rounded-md text-sm font-medium text-white" onClick={() => navigate(`/project/${project.slug}`, {state: project})}>
                                    View Details
                                </button>
                            </div>
                        </div>
