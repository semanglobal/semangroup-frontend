        ...
        <div className='py-28 px-4 sm:px-6 lg:px-8' style={{backgroundImage: `url(${bgPatterns.bg_pattern_6})`}}>
            <div className='max-w-[1440px] mx-auto '>
                <div className="flex justify-between">
                    ...
                    <div className="flex items-center gap-2 px-16 font-medium h-14 bg-primary hover:bg-black transition-colors duration-500 cursor-pointer">
                ...
                <div className="flex justify-between gap-6 mt-12">
                    {projects.map((project, index) => (
                        <div key={index} className="relative">
                            <div className="h-[390px] min-w-[360px] w-[380px] overflow-hidden rounded-2xl relative cursor-pointer group transition " onClick={() => navigate(project.link)}>
