...
const EnhancedMap = () => {
    ...
    return (
        <div className="relative w-full h-150 overflow-hidden shadow group">
            ...
            {/* Address Card */}
            <div
                className={`absolute top-8 left-8 bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-6 max-w-sm transition-all duration-500 transform ${isCardHovered ? 'scale-105 shadow-2xl' : 'shadow-xl'
                    }`}
